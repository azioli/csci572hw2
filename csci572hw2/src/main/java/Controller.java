...
public class Controller {
    ...
    public static void main(String[] args) throws Exception {
        ...
        BufferedWriter fetch_file=Files.newBufferedWriter(Paths.get("fetch_Washington_Post.csv"));
        BufferedWriter visit_file=Files.newBufferedWriter(Paths.get("visit_Washington_Post.csv"));
        BufferedWriter urls_file=Files.newBufferedWriter(Paths.get("urls_Washington_Post.csv"));
        ...
        BufferedWriter stat_file=Files.newBufferedWriter(Paths.get("CrawlReport_Washington_Post.txt"));
        stat_file.write("Name: Guanyu Lu\n" +
                "USC ID: 6093827787\n" +
                "News site crawled: Washington_Post\n\n");
